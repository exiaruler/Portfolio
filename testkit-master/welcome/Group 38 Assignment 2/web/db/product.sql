...
insert into product (productName,
    ...
    productBrand) values 
(
     'D Link DGS 1005A 5 Port Gigabit Desktop Switch', 25.00, 
...
insert into product (productName,
    ...
    productBrand) values 
(
     'ASUS AiMesh RT AX56U Wireless Dual Band 802.11ax WiFi Router', 319.00, 
    'The AX1800 Dual Band WiFi 6 Router supports MU MIMO and OFDMA technology, with AiProtection Pro network security powered by Trend Micro, compatible with ASUS AiMesh WiFi system', 500, 'Networking', 'ASUS'
);
...
insert into product (productName,
    ...
    productBrand) values 
(
   'ASUS PCE AC58BT Dual Band Wireless AC/Bluetooth Adapter', 89.00, 
...
insert into product (productName,
    ...
    productBrand) values 
(
    'D Link EXO AC1750 Dual Band Smart Mesh Wi Fi Router', 229.00, 
...
insert into product (productName,
    ...
    productBrand) values
(
     'MB7389 HRXL MAXSONAR WRMT MAXBOTIX ULTRASONIC SENSOR', 189.00,
...
insert into product (productName,
    ...
    productBrand) values 
(
    'Edimax AC1200 Dual Band Gigabit Router and Access Point', 79.00,
    'The Edimax BR 6478AC V2 dual band 802.11ac router features the latest 11ac standard for faster, better Wi Fi and built in VPN support ',
    500, 'Sensor', 'Edimax'
);
...
insert into product (productName,
    ...
    productBrand) values 
(
     'Netgear Nighthawk X4S Dual Band AC2600VDSL/ADSL Modem Router', 429.00,
    'he Netgear Nighthawk X4S AC2600 WiFi VDSL/ADSL Modem Router with MU MIMO and Quad Stream technology delivers WiFi to multiple devices',
...
insert into product  (productName,
    ...
    productBrand)values 
(
     'Netgear DM200 High Speed ADSL2+/VDSL Modem', 189.00,
...
insert into product (productName,
    ...
    productBrand) values 
(
   'TP Link Archer VR600V VoIP VDSL ADSL Modem Router', 199.00,
...
insert into product (productName,
    ...
    productBrand) values 
(
    'Particle Boron 2G/3G Kit', 141.35,
